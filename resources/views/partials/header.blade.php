        ...
        <div class="header clearfix">
            ...
            <ul class="sf-menu header_right">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="wide">
                                ...
                                <li>
                                    <a href="index0441.html?page=shortcodes#testimonials-announcement"
                                        title="Testimonials &amp; Announcement">
                                        Testimonials &amp; Announcement
                                    </a>
                                </li>
                                <li>
                                    <a href="index0441.html?page=shortcodes#accordiontab-notifications"
                                        title="Accordion &amp; Notifications">
                                ...
                                <li>
                                    <a href="index0441.html?page=shortcodes#buttons-headings"
                                        title="Buttons &amp; Headings">
                                        Buttons &amp; Headings
                                    </a>
                                </li>
                                <li>
                ...
                <li class="submenu wide">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="indexc6f4.html?page=departments#laryngological-clinic"
                        ...
                        <li>
                            <a href="indexc6f4.html?page=departments#gynaecological-clinic"
                                title="Gynaecological Clinic">
                                Gynaecological Clinic
                            </a>
                        </li>
                        <li>
                            <a href="indexc6f4.html?page=departments#outpatient-rehabilitation"
                ...
                <li class="submenu wide">
                    ...
                    <ul class="timetable_submenu">
                        ...
                        <li>
                            <a href="indexf608.html?page=timetable#outpatient-rehabilitation"
                                title="Outpatient Rehabilitation">
                                Outpatient Rehabilitation
                            </a>
                        </li>
            ...
            <div class="mobile_menu">
                <select>
                    ...
                    <option value="?page=shortcodes#testimonials-announcement">-- Testimonials &amp; Announcement
                    </option>
                    <option value="?page=shortcodes#accordiontab-notifications">-- Accordion &amp; Notifications
                    </option>
